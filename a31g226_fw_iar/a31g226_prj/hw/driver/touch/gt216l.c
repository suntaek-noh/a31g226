...
bool gt216lInit(void)
{
  ...
  if(i2cWriteBytes(_DEF_I2C2, GT216L_CHIP1_ADDR, GT21L_IO_DIR1, touch_cfg, 4, 1000) != true)
  {
    logPrintf("touch ic1 init GT21L_IO_DIR1 error \r\n");
    ret = false;
  }

  if(i2cWriteBytes(_DEF_I2C2, GT216L_CHIP1_ADDR, GT216L_SENSITIVITY_CONTROL, touch_sensitivity_cfg, 10, 1000) != true)
  {
  ...
  if(i2cWriteBytes(_DEF_I2C2, GT216L_CHIP2_ADDR, GT21L_IO_DIR1, touch_cfg, 4, 1000) != true)
  {
    logPrintf("touch ic2 init GT21L_IO_DIR1 error \r\n");
    ret = false;
  }

  if(i2cWriteBytes(_DEF_I2C2, GT216L_CHIP2_ADDR, GT216L_SENSITIVITY_CONTROL, touch_sensitivity_cfg, 10, 1000) != true)
  {
...
uint8_t gt216lGetTouchStatus(uint8_t ic)
{
  ...
  if(i2cReadBytes(_DEF_I2C2, GT216L_CHIP1_ADDR, GT216L_TOUCH_STATUS, &ret, 1, 1000) != true)
  {
...
bool gt216lGetTouchData(uint8_t ic, uint8_t *p_data)
{
  ...
  {
    case 0:
      if(i2cReadBytes(_DEF_I2C2, GT216L_CHIP1_ADDR, GT216L_TOUCH_OUT, (uint8_t *)p_data, 2, 1000) != true)
      {
    ...
    case 1:
      if(i2cReadBytes(_DEF_I2C2, GT216L_CHIP2_ADDR, GT216L_TOUCH_OUT, (uint8_t *)p_data, 2, 1000) != true)
      {
