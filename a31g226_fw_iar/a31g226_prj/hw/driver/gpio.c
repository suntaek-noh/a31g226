...
gpio_tbl_t gpio_tbl[GPIO_MAX_CH] =
    {
        {(PORT_Type *)PF, 4,  _DEF_OUTPUT, _DEF_HIGH, _DEF_LOW, _DEF_LOW},        //0
        {(PORT_Type *)PF, 3,  _DEF_OUTPUT, _DEF_HIGH, _DEF_LOW, _DEF_LOW},        //1
        {(PORT_Type *)PF, 2,  _DEF_OUTPUT, _DEF_HIGH, _DEF_LOW, _DEF_LOW},        //2
        {             PD, 1,  _DEF_OUTPUT, _DEF_HIGH, _DEF_LOW, _DEF_LOW},        //3
        {             PD, 0,  _DEF_OUTPUT, _DEF_HIGH, _DEF_LOW, _DEF_LOW},        //4
        {             PC, 12, _DEF_OUTPUT, _DEF_HIGH, _DEF_LOW, _DEF_LOW},        //5       

        {             PA, 11, _DEF_OUTPUT,_DEF_HIGH, _DEF_LOW, _DEF_LOW},         //6
        {             PA, 10, _DEF_OUTPUT,_DEF_HIGH, _DEF_LOW, _DEF_LOW},         //7
        {             PA, 9,  _DEF_OUTPUT,_DEF_HIGH, _DEF_LOW, _DEF_LOW},         //8
        {             PA, 8,  _DEF_OUTPUT,_DEF_HIGH, _DEF_LOW, _DEF_LOW},         //9
        
        {             PB, 10, _DEF_OUTPUT,_DEF_HIGH, _DEF_LOW,  _DEF_LOW},        //10     backligh

        {             PA, 3, _DEF_INPUT, _DEF_LOW, _DEF_HIGH,  _DEF_HIGH},        //11    touch1 int
        {             PA, 2, _DEF_INPUT, _DEF_LOW, _DEF_HIGH,  _DEF_HIGH},        //12    touch2 int
       
        {             PE, 11, _DEF_OUTPUT,_DEF_LOW, _DEF_HIGH,  _DEF_HIGH},       //13   touch rst
        {             PE, 10, _DEF_OUTPUT,_DEF_LOW, _DEF_HIGH,  _DEF_HIGH},       //14   전력센서 rst
    };
